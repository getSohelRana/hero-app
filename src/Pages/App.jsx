...
const App = () => {
    ...
    const searchedApps = toSignleString ? apps.filter(app => app.title.toLocaleLowerCase().includes(toSignleString)) : apps;
    ...
    return (
        <div className='container mx-auto my-10 px-2'>
            ...
            <div className='flex justify-between items-center mt-7'>
                <div className='text-xl font-semibold'>({searchedApps.length}) App Founds</div>
                <label className="input">
                    ...
                    <input value={search} onChange={(e) => setSearch(e.target.value)} type="search" required placeholder="Search your app" />
                </label>
            </div>
            {/* search functionlity */}
            {
